...
<br />
    ...
    <div class="bounce2">
        ...
        <h4> Text</h4>
        <img src="../logo/text.png" width="30px" style="margin-left:10px;"/>
    </div>

<br />

<div class="wrapper">
    <a href="doc.php" class="mdc-button">
...
<br />
			...
			if ($_GET['fa'] == "sterge") {
				$sql = "DELETE FROM `documente` WHERE Titlu='" . $_GET['titlu'] . "' and Id='" . $_GET['test'] . "'";
			    $stmt = $conn->query($sql);
			}
			...
			while ($row = $stmt->fetch()) {
					...
					echo "<div class='wrapper' id='formular'>";
						echo '<a href="http://gnets.myds.me/work/text/doc.php?id=' . $row['Id'] . '&fa=edit" class="mdc-button">
						   <span class="mdc-button__ripple"></span>
						   <span class="mdc-button__label">' . $row['Titlu'] . '</span>
						</a><br />';
						echo '<input class="linkinput" type="text" id="' . $row['Id'] . '" value="alexs.gq/t#' . $row['Id'] . '" readonly="readonly">';
			...
			if ($sunt_files == false) {
				echo "<div class='wrapper' style='text-align:center;'>
						...
						<p>Create one from the new document button.</p>
					  </div>";
			}
?>
<br />
