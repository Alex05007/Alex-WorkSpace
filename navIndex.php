...
<?php
  ...
  if ($_GET['prieteni'] != "") {
	  ...
	  for ($i=0; $i<count($pri); $i++) {
		  $sql = "SELECT * FROM `conturi` WHERE Id = '" . $pri[$i] . "'";
		  $stmt = $conn->query($sql);
	  	  if ($row = $stmt->fetch()) {
			  $pr = str_replace($_COOKIE['login'].";", "", $row['prieteni']);
			  $pr2 = "UPDATE conturi SET prieteni = '" . $pr . "' WHERE Id = '" . $pri[$i] . "'";
			  $pri2 = $conn->query($pr2);
		  }
	  } 
...
$('#menu').not('#content').click(function () { 
        menu_up();
});
...
<div class="navbar">
	...
	?>
    <div class="button-ripple img" onmousedown="setTimeout(function() {location.assign('chat')}, 500);" data-ripple-color="#CCC"><img src="logo/chat.png" width="50px;"/></div>
    <div class="button-ripple img" onmousedown="setTimeout(function() {location.assign('classroom')}, 500);" data-ripple-color="#CCC"><img src="logo/class.png" width="50px;"/></div>
    <div class="button-ripple img" onmousedown="setTimeout(function() {location.assign('video')}, 500);" data-ripple-color="#CCC"><img src="logo/video.png" width="50px;"/></div>
    <div class="button-ripple img" onmousedown="setTimeout(function() {location.assign('forms')}, 500);" data-ripple-color="#CCC"><img src="logo/forms.png" width="50px;"/></div>
    <div class="button-ripple img" onmousedown="setTimeout(function() {location.assign('text')}, 500);" data-ripple-color="#CCC"><img src="logo/text.png" width="50px;"/></div>
    <div class="button-ripple img" style="margin-right:0px;" onmousedown="setTimeout(function() {location.assign('slides')}, 500);" data-ripple-color="#CCC"><img src="logo/slides.png" width="50px;"/></div>
...
<div class="menu" id="menu">
    ...
    <div id="content">
        ...
        <div class="assistant" id="as">
        	<p class="user" id="user" style="display:none;"><?php echo "<img src='https://eu.ui-avatars.com/api/?background=" . $_COOKIE['color']. "&color=fff&name=" . $_COOKIE['un'] . "&size=40&rounded=true' alt='avatar' />"; ?><div id="question"></div></p><br /><br />
        	<p class="alex" id="alex" style="display:none;"><img src="logo.png" width="30px"/><div id="answer"></div></p><br /><br />
            <div class="yn">
            	<table style="text-align:center;">
                	<tr>
                        <td><i id="yes" class="fas fa-vote-yea"></i></td>
                        <td><i id="no" class="far fa-times-circle"></i></td>
                    </tr>
                </table>
            </div>
        </div>
        
        <div class="recorder-container" onclick="rec()">
            <div class="outer" id="anim1"></div>
            <div class="outer-2" id="anim2"></div>
            <div class="icon-microphone"> <i class="fas fa-microphone"></i></div>
        </div>
    </div>
